...
/* arduino output
  "${HOME}/AppData/Local/Arduino15/packages/esp8266/tools/xtensa-lx106-elf-gcc/2.5.0-4-b40a506/bin/xtensa-lx106-elf-gcc" 
  -fno-exceptions -Wl,-Map "-Wl,${HOME}/AppData/Local/Temp/arduino_build_278104/WIFIUnoTest.ino.map" 
  -g -w -Os -nostdlib -Wl,--no-check-sections -u app_entry -u _printf_float -u _scanf_float 
  -Wl,-static 
  "-L${HOME}/AppData/Local/Arduino15/packages/esp8266/hardware/esp8266/2.7.4/tools/sdk/lib" 
  "-L${HOME}/AppData/Local/Arduino15/packages/esp8266/hardware/esp8266/2.7.4/tools/sdk/lib/NONOSDK22x_190703" 
  "-L${HOME}/AppData/Local/Arduino15/packages/esp8266/hardware/esp8266/2.7.4/tools/sdk/ld" 
  "-L${HOME}/AppData/Local/Arduino15/packages/esp8266/hardware/esp8266/2.7.4/tools/sdk/libc/xtensa-lx106-elf/lib" 
  -Teagle.flash.1m64.ld 
  -Wl,--gc-sections 
  -Wl,-wrap,system_restart_local 
  -Wl,-wrap,spi_flash_read 
  -o "${HOME}/AppData/Local/Temp/arduino_build_278104/WIFIUnoTest.ino.elf" 
  -Wl,--start-group 
  "${HOME}/AppData/Local/Temp/arduino_build_278104/sketch/WIFIUnoTest.ino.cpp.o" 
  "${HOME}/AppData/Local/Temp/arduino_build_278104/libraries/ESP8266WiFi/ESP8266WiFi.a" 
  "${HOME}/AppData/Local/Temp/arduino_build_278104/core/core.a" 
  ...
  -Wl,--end-group 
  "-L${HOME}/AppData/Local/Temp/arduino_build_278104"

our output:
 ${HOME}/AppData/Local/Arduino15/packages/esp8266/tools/xtensa-lx106-elf-gcc/2.5.0-4-b40a506/bin/xtensa-lx106-elf-gcc.exe 
 ...
 -Wl,-Map -Wl,ROOT/.built/esp8266-generic-win32-win32-debug/Blink/blink.map -L${HOME}/AppData/Local/Arduino15/packages/esp8266/hardware/esp8266/2.7.4/tools/sdk/lib -L${HOME}/AppData/Local/Arduino15/packages/esp8266/hardware/esp8266/2.7.4/tools/sdk/lib/NONOSDK22x_190703 -L${HOME}/AppData/Local/Arduino15/packages/esp8266/hardware/esp8266/2.7.4/tools/sdk/ld -L${HOME}/AppData/Local/Arduino15/packages/esp8266/hardware/esp8266/2.7.4/tools/sdk/libc/xtensa-lx106-elf/lib -LROOT/.built/esp8266-generic-win32-win32-debug/Blink 
