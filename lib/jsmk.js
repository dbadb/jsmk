...
function Jsmk() // ---- constructor  ----------------------------------
{
    ...
    this.m_buildPolicy = policy.NewBuildPolicy(this, this.m_host, this.m_user);
...
Jsmk.prototype = 
{
    BeginSession : function()
    {
        ...
        this.DEBUG("Policy: " + JSON.stringify(this.m_buildPolicy));
    },
    ...
    parseArgs : function() 
    {
        ...
        if(!err)
        {
            this.m_buildPolicy.Init(rootdir, this.m_user.ConfigDir, 
                                    policynm, stages, 
                                    perform, threads);
            return;
        }
