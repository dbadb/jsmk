...
class Policy
{
    constructor(config)
    {
        ...
        this.LocalFrameworkDir = 
        {
            "win32": path.join(jsmk.GetUser().HomeDir, ".jsmk/frameworks"),
            "linux": path.join(jsmk.GetUser().HomeDir, ".jsmk/frameworks"),
            "darwin": "/opt/homebrew/Cellar",
